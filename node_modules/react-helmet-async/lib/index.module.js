...
var l = {
        ...
        return r.filter(function(e) {
            ...
            r.filter(function(t) {
                for (var r, o = Object.keys(t), a = 0; a < o.length; a += 1) {
                    var s = o[a],
                        c = s.toLowerCase(); - 1 === e.indexOf(c) || "rel" === r && "canonical" === t[r].toLowerCase() || "rel" === c && "stylesheet" === t[c].toLowerCase() || (r = c), -1 === e.indexOf(s) || "innerHTML" !== s && "cssText" !== s && "itemprop" !== s || (r = s)
                }
                if (!r || !t[r]) return !1;
    ...
    q = /*#__PURE__*/ function(e) {
        ...
        return s(r, e), r.prototype.render = function() { /*#__PURE__*/
...
var Y = function(t, e) {
        var r, n = document.head || document.querySelector(l.HEAD),
    ...
    K = function(t, e) {
        var r = t.baseTag,
            ...
            p = t.title,
            f = t.titleAttributes;
        B(l.BODY, t.bodyAttributes), B(l.HTML, n),
            function(t, e) {
    ...
    W = /*#__PURE__*/ function(e) {
        ...
        return o.shouldComponentUpdate = function(t) {
            ...
            return r && (i = this.mapChildrenToProps(r, i)), !o || o instanceof N || (o = new N(o.context, o.instances)), o ? /*#__PURE__*/ t.createElement(z, a({}, i, {
                context: o.value,
                helmetData: void 0
            })) : /*#__PURE__*/ t.createElement(R.Consumer, null, function(e) { /*#__PURE__*/
...
export {
    W as Helmet, N as HelmetData, q as HelmetProvider
};
